...
export GUM_CHOOSE_HEADER_FOREGROUND="$PURPLE"
export GUM_CHOOSE_SELECTED_FOREGROUND="$GREEN"
export GUM_CHOOSE_CURSOR_FOREGROUND="$GREEN"
export GUM_CONFIRM_PROMPT_FOREGROUND="$PURPLE"
...
clear
gum style "Great! Now let's select where to install Arch..." --foreground "$BLUE"
echo ""
while true; do
